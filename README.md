...
````
The results will be saved in `test_results/human_mesh_test/` by default. `human_test_list` is randomly choosed for testing.
...
````
The results will be saved in `test_results/animal_mesh_test/` by default. `animal_test_list` is randomly choosed for testing.
