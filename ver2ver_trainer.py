...
class Ver2VerTrainer():
    ...
    def train_model(self, identity_points, pose_points, id_face, arap_flag):
        self.optimizer.zero_grad()
        losses, out = self.ver2ver_model(identity_points, pose_points, id_face, arap_flag, mode='train')
